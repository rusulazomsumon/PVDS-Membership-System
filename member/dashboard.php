...
<div class="content">
  ...
  <div>
          ...
          <t1 id="HeadText">Newly Applied Member</t1>
          <table id="box">
        ...
        <!-- PHP Sqli Qurary for faching data  -->  
          <?php
              ...
              $sql = "SELECT pic, m_name, sex, phone, upzila, zila, pvds_id  FROM regi WHERE action='NO'";
          ...
          ?>        
                      	    <tr>
                                ...
                                <td><a href="/pvds/member/hold.php?pvds_id=<?php echo $row['pvds_id']; ?>" >HOLD</a></td>
                                <td><td><a href="/pvds/member/approve.php?pvds_id=<?php echo $row['pvds_id']; ?>">Approve</a></td></td>
                              </tr>             
          <?php            
  ...
  <a href="/pvds/member/allMemberlist.php"><h2>All Member List</h2></a>
