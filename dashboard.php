...
<!-- Banner -->
<a href="/pvds" class="btn w-full btn-primary text-truncate rounded-0 py-2 border-0 position-relative" style="z-index: 1000;">
    ...
    <nav class="navbar show navbar-vertical h-lg-screen navbar-expand-lg px-0 py-3 navbar-light bg-white border-bottom border-bottom-lg-0 border-end-lg" id="navbarVertical">
        <div class="container-fluid">
            ...
            <a class="navbar-brand py-lg-2 mb-lg-5 px-lg-6 me-0" href="#">
                <img src="img/pvds-logo.png" alt="PVDS Logo">
            </a>
            <!-- User menu (mobile) -->
            <div class="navbar-user d-lg-none">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="sidebarAvatar">
                        ...
                        <a href="/pvds/logout.php" class="dropdown-item">Logout</a>
                    </div>
                </div>
            </div>
            <!-- Collapse -->
            <div class="collapse navbar-collapse" id="sidebarCollapse">
                ...
                <ul class="navbar-nav">
                    ...
                    <a class="nav-link" href="/pvds/member/addMember.php">
                            <i class="bi bi-plus"></i> Add Member 
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/pvds/member/allMemberList.php">
                            <i class="bi bi-bar-chart"></i> Member List
                        </a>
                    </li>
                    <li class="nav-item">
                    <a class="nav-link" href="#">
                            <i class="bi bi-app-indicator"></i> Member Request 
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/pvds/logout.php">
            ...
            <!-- Card stats -->
                    ...
                    <div class="col-xl-3 col-sm-6 col-12">
                        <div class="card shadow border-0">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <span class="h6 font-semibold text-muted text-sm d-block mb-2">Total Fee Collection</span>
                                        <span class="h3 font-bold mb-0">50000৳</span>
                                    </div>
                                    <div class="col-auto">
                    ...
                    <div class="col-xl-3 col-sm-6 col-12">
                        <div class="card shadow border-0">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <span class="h6 font-semibold text-muted text-sm d-block mb-2">Total Member</span>
                                        <span class="h3 font-bold mb-0">2135</span>
                                    </div>
                                    <div class="col-auto">
                ...
                <div class="card shadow border-0 mb-7">
                    <div class="card-header">
                        <h5 class="mb-0">New Member Request</h5>
                    </div>
